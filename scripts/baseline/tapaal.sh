...
function LTL {
        ...
        STRATEGIES_PAR[0]="-ltl tarjan -q 0 -l 0 -p -s DFS -d $SHORTRED"
        STRATEGIES_PAR[1]="-ltl ndfs -q 0 -l 0 -p -s DFS -d $SHORTRED"
        STRATEGIES_PAR[2]="-ltl ndfs -q 0 -l 0 -p -s RDFS -d $SHORTRED"
        STRATEGIES_PAR[3]="-ltl tarjan -q 0 -l 0 -p -s RDFS -d $SHORTRED"
        unset STRATEGIES_SEQ
        STRATEGIES_SEQ[0]="-ltl tarjan -q 40 -l 5 -p -s DFS -d $SHORTRED"
        unset STRATEGIES_RAND
        STRATEGIES_RAND[0]="-ltl tarjan -s RDFS -p --seed-offset 0 -q 0 -l 0 -d $SHORTRED"
        STRATEGIES_RAND[1]="-ltl tarjan -s RDFS -p --seed-offset 1337 -q 0 -l 0 -d $SHORTRED"
        STRATEGIES_RAND[2]="-ltl tarjan -s RDFS -p --seed-offset 2018 -q 0 -l 0 -d $SHORTRED"
	STRATEGIES_RAND[3]="-ltl tarjan -s RDFS -p --seed-offset 9220 -q 0 -l 0 -d $SHORTRED"
